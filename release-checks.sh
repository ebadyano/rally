...
then
    echo "Error: to let git create signed commits on Mac OS you need to set \"export GPG_TTY=\$(tty)\"."
    exit 1
fi

# Check if there will be any errors during CHNAGELOG.md generation
